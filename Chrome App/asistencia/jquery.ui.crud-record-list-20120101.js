			...
			repaint: function() {
				...
				for (i = 0; i < this.options.records.dataRows.length; i++) {
					...
					for (c = 0; c < this.options.records.columns.length; c++) {
							...
							var fieldName  = $("<span class='label-field'>"   + this.options.records.columns[c] + ":&nbsp;&nbsp;</span>");
							var fieldValue = $("<span class='content-field'>" + this.options.records.dataRows[i][c] + "</span><br>");
