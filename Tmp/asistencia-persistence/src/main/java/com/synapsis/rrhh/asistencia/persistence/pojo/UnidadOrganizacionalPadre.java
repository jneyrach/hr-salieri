...
@Entity
@Table(name = "airh_ast_unid_org_padres")
public class UnidadOrganizacionalPadre extends com.synapsis.rrhh.asistencia.domainmodel.UnidadOrganizacionalPadre {
    ...
    public UnidadOrganizacionalPadre() {}
    
    public UnidadOrganizacionalPadre(com.synapsis.rrhh.asistencia.domainmodel.UnidadOrganizacionalPadre model) {
