...
@Entity
@Table(name = "airh_ast_tipos_horas")
public class TipoHora extends com.synapsis.rrhh.asistencia.domainmodel.TipoHora {

    @Id
    @TableGenerator(name = "airh_ast_tipos_horas", table = "AIRH_AST_ID", pkColumnName = "PK_NAME", valueColumnName = "PK_VALUE", allocationSize = 1, initialValue = 0)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "airh_ast_tipos_horas")
    @Column(name = "id")
    private Integer _id;
    ...
    public TipoHora(com.synapsis.rrhh.asistencia.domainmodel.TipoHora model) {
