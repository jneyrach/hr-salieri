...
@Entity
@Table(name = "airh_ast_ajustes_real")
public class AjusteHorarioReal extends com.synapsis.rrhh.asistencia.domainmodel.AjusteHorarioReal {
    ...
    @ManyToOne
    @JoinColumn(name = "hoja_real_id", referencedColumnName = "id")
    ...
    public AjusteHorarioReal() {}
    
    public AjusteHorarioReal(com.synapsis.rrhh.asistencia.domainmodel.AjusteHorarioReal model) {
        
        this._id = model.getId();
        this._hojaTiempoReal = (HojaTiempoHorarioReal) model.getHojaTiempoReal();
    ...
    public void setHojaTiempoReal(com.synapsis.rrhh.asistencia.domainmodel.HojaTiempoHorarioReal hojaTiempoReal) {
        this._hojaTiempoReal = (HojaTiempoHorarioReal) hojaTiempoReal;
        super.setHojaTiempoHorarioReal(_hojaTiempoReal);
    }
