...
@Entity
@Table(name = "airh_ast_festivos")
public class DiaFestivo extends com.synapsis.rrhh.asistencia.domainmodel.DiaFestivo {
    ...
    public void setFechaFestivo(Date fechaFestivo) {
        ...
        super.setFechaFestivo(fechaFestivo);
    }
    ...
    public DiaFestivo(com.synapsis.rrhh.asistencia.domainmodel.DiaFestivo model) {
