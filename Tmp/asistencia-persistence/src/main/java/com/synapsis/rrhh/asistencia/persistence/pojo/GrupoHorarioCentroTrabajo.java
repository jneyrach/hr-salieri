...
@Entity
@Table(name = "airh_ast_grupos_horario")
public class GrupoHorarioCentroTrabajo extends com.synapsis.rrhh.asistencia.domainmodel.GrupoHorarioCentroTrabajo {

    @Id
    @TableGenerator(name = "airh_ast_grupos_horario", table = "AIRH_AST_ID", pkColumnName = "PK_NAME", valueColumnName = "PK_VALUE", allocationSize = 1, initialValue = 0)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "airh_ast_grupos_horario")
    @Column(name = "id")
    private Integer _id;
    ...
    public GrupoHorarioCentroTrabajo() {}
    
    public GrupoHorarioCentroTrabajo(com.synapsis.rrhh.asistencia.domainmodel.GrupoHorarioCentroTrabajo model) {
