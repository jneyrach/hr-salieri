...
@Entity
@Table(name = "airh_ast_ubi_geo")
public class UbicacionGeografica extends com.synapsis.rrhh.asistencia.domainmodel.UbicacionGeografica {

    @Id
    @TableGenerator(name = "airh_ast_ubi_geo", table = "AIRH_AST_ID", pkColumnName = "PK_NAME", valueColumnName = "PK_VALUE", allocationSize = 1, initialValue = 0)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "airh_ast_ubi_geo")
    @Column(name = "id")
    private Integer _id;
    ...
    public UbicacionGeografica(com.synapsis.rrhh.asistencia.domainmodel.UbicacionGeografica model) {
