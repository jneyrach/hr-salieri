...
@Entity
@Table(name = "airh_ast_tipos_dias")
public class TipoDia extends com.synapsis.rrhh.asistencia.domainmodel.TipoDia {

    @Id
    @TableGenerator(name = "airh_ast_tipos_dias", table = "AIRH_AST_ID", pkColumnName = "PK_NAME", valueColumnName = "PK_VALUE", allocationSize = 1, initialValue = 0)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "airh_ast_tipos_dias")    
    @Column(name = "id")
    private Integer _id;
    ...
    public TipoDia(com.synapsis.rrhh.asistencia.domainmodel.TipoDia model) {
