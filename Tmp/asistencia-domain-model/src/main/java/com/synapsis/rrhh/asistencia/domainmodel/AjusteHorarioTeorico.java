...
public abstract class AjusteHorarioTeorico extends BaseDomainEntity {
    ...
    public void setHojaTiempoTeorico(HojaTiempoHorarioTeorico hojaTiempoTeorico) {
        this._hojaTiempoTeorico = hojaTiempoTeorico;
    }
